Feature: The cucumber plugin and old versions of gradle
  ...
  Scenario Outline: The cucumber plugin will no longer work with old gradle versions
    ...
    Then I should see "Could not find property 'classesDirs' on cucumber output."
